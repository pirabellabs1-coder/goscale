...
import {
  LayoutDashboard, BarChart3, FolderOpen, MessageSquare, Star, FileText, Users,
...
const sidebarLinks = [
  ...
  { href: `${PANEL}/clients`, label: "Clients", icon: Users },
  { href: `${PANEL}/quotes`, label: "Devis", icon: FileText },
