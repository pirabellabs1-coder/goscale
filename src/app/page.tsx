        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {processSteps.map((s, i) => (
              <div key={i} className="relative glass rounded-2xl p-5 sm:p-8 text-center group hover:-translate-y-1 transition-all duration-300">
                <div className="text-2xl sm:text-4xl font-display font-bold text-brand/20 mb-3 sm:mb-4">{s.num}</div>
      ...
      <section className="py-24 px-6" ref={statsRef}>
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
            {stats.map((s, i) => (
              <div key={i} className="glass rounded-2xl p-4 sm:p-8 text-center">
          ...
          {publishedProjects.length === 0 ? (
            ...
            <>
              <div className="grid md:grid-cols-2 gap-8">
                {(showAllProjects ? publishedProjects : publishedProjects.slice(0, 4)).map((p) => {
              ...
              {publishedProjects.length > 4 && !showAllProjects && (
